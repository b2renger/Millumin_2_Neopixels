  ...
  if (Serial.available() > 0) { //makes sure something is ready to be read
    ...
    // inside this else we can recover our values ​​and use them
      ...
      bufpos = 0; //restart the position of the buff
       ...
       r = atoi(subStr(serialbuf, ",", 1)); // get the first value and store it in a variable
       g = atoi(subStr(serialbuf, ",", 2)); // get back the second ...
       b = atoi(subStr(serialbuf, ",", 3)); // get back the third ...
